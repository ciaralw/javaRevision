...
public class CharRemovalQ {
	...
	//do it this way
	//here you pass in the values of the variables animal and n when calling this method removeChar3() on an object inside the main method
	//the new String newAnimal is returned when this method is called
